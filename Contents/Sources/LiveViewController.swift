...
public class LiveViewController: UIViewController, PlaygroundLiveViewSafeAreaContainer {
    ...
    override public func viewDidAppear(_ animated: Bool) {
        ...
        UIAccessibilityPostNotification(UIAccessibilityAnnouncementNotification, view)
    }
    ...
    @objc func axDescriptionAnnouncement() -> Bool {
        ...
        if planeCount == 0 && objectCount == 0 && characterCount == 0 {
         ...
         UIAccessibilityPostNotification(UIAccessibilityAnnouncementNotification, arSceneViewAXDescription)
        return true
    }
    ...
    func updateVirtualObjectPosition(object: VirtualObject, _ pos: SCNVector3, _ filterPosition: Bool) {
        ...
        guard !placedObjects.isEmpty else {
            log(message: "No objects have been placed in the scene.")
            return
        }
    ...
    public func announceObjectPlacement(objects: [PlaceableObject]) {
        ...
        UIAccessibilityPostNotification(UIAccessibilityScreenChangedNotification, initialObjectPlacementText)
    }
    ...
    func addPlane(node: SCNNode, anchor: ARPlaneAnchor) {
        updateQueue.async {
            ...
            DispatchQueue.main.async {
                ...
                UIAccessibilityPostNotification(UIAccessibilityScreenChangedNotification, axPlaneFoundText)
                self.send(
